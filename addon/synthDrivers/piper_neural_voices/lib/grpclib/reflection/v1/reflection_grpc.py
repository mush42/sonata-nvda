...
class ServerReflectionBase(abc.ABC):
    ...
    async def ServerReflectionInfo(
        self,
        stream: "grpclib.server.Stream[grpclib.reflection.v1.reflection_pb2.ServerReflectionRequest, grpclib.reflection.v1.reflection_pb2.ServerReflectionResponse]",
    ) -> None:
        pass
