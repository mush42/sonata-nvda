...
class Channelz(ChannelzBase):
    async def GetTopChannels(
        self,
        stream: "Stream[GetTopChannelsRequest, GetTopChannelsResponse]",
    ) -> None:
        raise GRPCError(Status.UNIMPLEMENTED)

    async def GetServers(
        self,
        stream: "Stream[GetServersRequest, GetServersResponse]",
    ) -> None:
        raise GRPCError(Status.UNIMPLEMENTED)

    async def GetServer(
        self,
        stream: "Stream[GetServerRequest, GetServerResponse]",
    ) -> None:
        raise GRPCError(Status.UNIMPLEMENTED)
    ...
    async def GetChannel(
        self,
        stream: "Stream[GetChannelRequest, GetChannelResponse]",
    ) -> None:
        raise GRPCError(Status.UNIMPLEMENTED)

    async def GetSubchannel(
        self,
        stream: "Stream[GetSubchannelRequest, GetSubchannelResponse]",
    ) -> None:
        raise GRPCError(Status.UNIMPLEMENTED)

    async def GetSocket(
        self,
        stream: "Stream[GetSocketRequest, GetSocketResponse]",
    ) -> None:
        raise GRPCError(Status.UNIMPLEMENTED)
