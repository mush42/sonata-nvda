...
class Channel(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing_extensions.Literal["data", b"data", "ref", b"ref"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class ChannelConnectivityState(google.protobuf.message.Message):
    ...
    class _StateEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            ChannelConnectivityState._State.ValueType
        ],
        builtins.type,
    ):  # noqa: F821
...
class ChannelData(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        calls_succeeded: builtins.int = ...,
        calls_failed: builtins.int = ...,
        last_call_started_timestamp: google.protobuf.timestamp_pb2.Timestamp
        | None = ...,
    ) -> None: ...
    def HasField(
        self,
...
class ChannelTraceEvent(google.protobuf.message.Message):
    ...
    class _SeverityEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            ChannelTraceEvent._Severity.ValueType
        ],
        builtins.type,
    ):  # noqa: F821
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["child_ref", b"child_ref"]
    ) -> typing_extensions.Literal["channel_ref", "subchannel_ref"] | None: ...
...
class ChannelRef(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "channel_id", b"channel_id", "name", b"name"
        ],
    ) -> None: ...
...
class SubchannelRef(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "name", b"name", "subchannel_id", b"subchannel_id"
        ],
    ) -> None: ...
...
class SocketRef(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "name", b"name", "socket_id", b"socket_id"
        ],
    ) -> None: ...
...
class ServerRef(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "name", b"name", "server_id", b"server_id"
        ],
    ) -> None: ...
...
class Server(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "data", b"data", "listen_socket", b"listen_socket", "ref", b"ref"
        ],
    ) -> None: ...
...
class SocketData(google.protobuf.message.Message):
    ...
    """
    @property
    def last_local_stream_created_timestamp(
        self,
        ...
        """
    @property
    def last_remote_stream_created_timestamp(
        self,
    ) -> google.protobuf.timestamp_pb2.Timestamp:
    ...
    @property
    def last_message_received_timestamp(
        self,
    ) -> google.protobuf.timestamp_pb2.Timestamp:
    ...
    def __init__(
        ...
        *,
        ...
        messages_received: builtins.int = ...,
        keep_alives_sent: builtins.int = ...,
        last_local_stream_created_timestamp: google.protobuf.timestamp_pb2.Timestamp
        | None = ...,
        last_remote_stream_created_timestamp: google.protobuf.timestamp_pb2.Timestamp
        | None = ...,
        last_message_sent_timestamp: google.protobuf.timestamp_pb2.Timestamp
        | None = ...,
        last_message_received_timestamp: google.protobuf.timestamp_pb2.Timestamp
        | None = ...,
        local_flow_control_window: google.protobuf.wrappers_pb2.Int64Value | None = ...,
        remote_flow_control_window: google.protobuf.wrappers_pb2.Int64Value
        | None = ...,
    ...
    def HasField(
        ...
        field_name: typing_extensions.Literal[
            ...
            b"last_message_received_timestamp",
            "last_message_sent_timestamp",
            b"last_message_sent_timestamp",
            "last_remote_stream_created_timestamp",
            b"last_remote_stream_created_timestamp",
            "local_flow_control_window",
            b"local_flow_control_window",
            "remote_flow_control_window",
            b"remote_flow_control_window",
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class Address(google.protobuf.message.Message):
    ...
    class TcpIpAddress(google.protobuf.message.Message):
        ...
        def ClearField(
            self,
            field_name: typing_extensions.Literal[
                "ip_address", b"ip_address", "port", b"port"
            ],
        ) -> None: ...
    ...
    class UdsAddress(google.protobuf.message.Message):
        ...
        def ClearField(
            self, field_name: typing_extensions.Literal["filename", b"filename"]
        ) -> None: ...
    ...
    class OtherAddress(google.protobuf.message.Message):
        ...
        def ClearField(
            self,
            field_name: typing_extensions.Literal["name", b"name", "value", b"value"],
        ) -> None: ...
    ...
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["address", b"address"]
    ) -> typing_extensions.Literal[
        "tcpip_address", "uds_address", "other_address"
    ] | None: ...
...
class Security(google.protobuf.message.Message):
    ...
    class Tls(google.protobuf.message.Message):
        ...
        def WhichOneof(
            self,
            oneof_group: typing_extensions.Literal["cipher_suite", b"cipher_suite"],
        ) -> typing_extensions.Literal["standard_name", "other_name"] | None: ...
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "model", b"model", "other", b"other", "tls", b"tls"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["model", b"model"]
    ) -> typing_extensions.Literal["tls", "other"] | None: ...
...
class SocketOption(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing_extensions.Literal["additional", b"additional"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "additional", b"additional", "name", b"name", "value", b"value"
        ],
    ) -> None: ...
...
class SocketOptionLinger(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "active", b"active", "duration", b"duration"
        ],
    ) -> None: ...
...
class SocketOptionTcpInfo(google.protobuf.message.Message):
    ...
    def ClearField(
        ...
        field_name: typing_extensions.Literal[
            ...
            b"tcpi_fackets",
            "tcpi_last_ack_recv",
            b"tcpi_last_ack_recv",
            "tcpi_last_ack_sent",
            b"tcpi_last_ack_sent",
            "tcpi_last_data_recv",
            b"tcpi_last_data_recv",
            "tcpi_last_data_sent",
            b"tcpi_last_data_sent",
            "tcpi_lost",
            b"tcpi_lost",
            "tcpi_options",
            b"tcpi_options",
...
class GetTopChannelsRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "max_results", b"max_results", "start_channel_id", b"start_channel_id"
        ],
    ) -> None: ...
...
class GetTopChannelsResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal["channel", b"channel", "end", b"end"],
    ) -> None: ...
...
class GetServersRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "max_results", b"max_results", "start_server_id", b"start_server_id"
        ],
    ) -> None: ...
...
class GetServersResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["end", b"end", "server", b"server"]
    ) -> None: ...
...
class GetServerResponse(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing_extensions.Literal["server", b"server"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["server", b"server"]
    ) -> None: ...
...
class GetServerSocketsResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "end", b"end", "socket_ref", b"socket_ref"
        ],
    ) -> None: ...
...
class GetSubchannelRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["subchannel_id", b"subchannel_id"]
    ) -> None: ...
...
class GetSubchannelResponse(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing_extensions.Literal["subchannel", b"subchannel"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["subchannel", b"subchannel"]
    ) -> None: ...
...
class GetSocketRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "socket_id", b"socket_id", "summary", b"summary"
        ],
    ) -> None: ...
...
class GetSocketResponse(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing_extensions.Literal["socket", b"socket"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["socket", b"socket"]
    ) -> None: ...
